...
Revision ID: 21333208f42d
Revises: 
Create Date: 2023-09-12 00:52:16.595260
...
def upgrade():
    ...
    sa.Column('bankDetailsID', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('bankNameID', sa.Integer(), nullable=False),
    sa.Column('accountTypeID', sa.Integer(), nullable=False),
    sa.Column('bankAccountNumber', sa.String(length=8), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['accountTypeID'], ['AccountType.accountTypeID'], ),
    sa.ForeignKeyConstraint(['bankNameID'], ['Bank.bankID'], ),
    sa.ForeignKeyConstraint(['userID'], ['User.userID'], ),
    sa.PrimaryKeyConstraint('bankDetailsID')
    )
